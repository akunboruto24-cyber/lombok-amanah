...
const categoryLabels: Record<string, string> = {
  beach: 'Pantai / Beach',
  mountain: 'Gunung & Bukit / Mountain',
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        <div className="text-center mb-14">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="text-gold-400 text-[11px] font-semibold tracking-[0.25em] uppercase">Destinasi / Destinations</span>
            <div className="w-10 h-[1px] bg-gold-400" />
          </div>
          ...
          <p className="text-navy-900/50 max-w-2xl mx-auto text-[16px] font-light leading-[1.7]">
            ...
            <br />
            <span className="text-navy-900/30 text-[14px]">From exotic beaches to Mount Rinjani — discover Lombok&apos;s natural beauty and culture.</span>
          </p>
        </div>
